        ...
        <div className="bg-white rounded-lg shadow-xl pb-8">
          ...
          <div className="flex flex-col items-center -mt-20">
            ...
            >
              ...
              />
              <div className={`absolute right-3 bottom-3 bg-white rounded-full cursor-pointer p-1 ${show ? "block" : "hidden"}`}>
                <svg
            ...
            <button onClick={() => navigate("/editar-perfil")} className="py-2 px-4 border-gray-600 border-solid border-[1px] mt-3 rounded-md hover:bg-gray-600 hover:text-white">
              Editar Perfil
            </button>
          </div>
        ...
        <div className="w-full flex flex-col 2xl:w-1/3">
          <div className="flex-1 bg-white rounded-lg shadow-xl p-8">
            ...
            <ul className="mt-2 text-gray-700">
              ...
              <li className="flex border-y py-2">
                <span className="font-bold w-28 flex items-center">Sobrenome:</span>
                <span className="text-gray-700 flex items-center h-[3.2rem]">
                  {sobrenome}
                </span>
              </li>
              <li className="flex border-b py-2">
                <span className="font-bold w-28 flex items-center">Telefone:</span>
                <span className="text-gray-700 flex items-center h-[3.2rem]">
                  {telefone}
                </span>
              </li>
              ...
              <li className="flex border-b py-2">
                <span className="font-bold w-28 flex items-center">Cidade:</span>
                <span className="text-gray-700 flex items-center h-[3.2rem]">
                  {cidade}
                </span>
              </li>
